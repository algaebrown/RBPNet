...
def original_rbpnet_loss(outputs,
    targets):
    ''' reviewer asked us to benchmark without the additional layer'''
    return rbpnet_loss(outputs, targets, w=0)
